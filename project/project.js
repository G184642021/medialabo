let data = {
  ...
  z=0;
   // URL を設定
    ...
    let sota =e.value;
   let url = 'https://www.nishita-lab.org/web-contents/jsons/hotpepper/'+sota+'.json';
  ...
  function showResult(resp) {
   ...
   // data.x を出力
    for(let n of data.results.shop){
      ...
      p2.textContent = n.name;
      ta.insertAdjacentElement('afterend', p2);
      p.textContent = n.access;
      ta.insertAdjacentElement('afterend', p);
      p3.textContent = n.address;
      ta.insertAdjacentElement('afterend', p3);
      z++;
    }
  }
